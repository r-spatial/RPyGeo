...
This extends R's spatial capabilities by the geoalgorithms (many of which are unavailable in R) and the geoprocessing power of a Desktop GIS (usually written in a compiled programming language).
