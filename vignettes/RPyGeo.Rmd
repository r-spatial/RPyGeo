...
Please note that the availability of extensions is dependent on the purchased ArcGIS license.
The `extension` codewords are listed on the ArcGIS [help page](http://desktop.arcgis.com/de/arcmap/10.3/analyze/arcpy-functions/checkoutextension.htm). 
One can check the availability using `CheckExtension()` and a specific extension codeword:
