...
In this tutorial we use geographic data from the **spData** package.
<!-- well, this is an "artificial" dem, why don't you just use data(dem, package = "RQGIS")-->
The `elev` and `nz` dataset are used to demonstrate raster and vector file operations.  
...
In a first step, we have to export the spatial data we would like to use in the subsequent ArcMap geoprocessing. 
